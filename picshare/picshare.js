...
var $author$project$Picshare$saveComments = function (model) {
		...
		switch (msg.$) {
			...
			case 'UpdateComment':
				...
				return _Utils_update(
					...
					{newComment: comment});
			default:
				return $author$project$Picshare$saveComments(model);
		}
	});
...
var $author$project$Picshare$viewLoveButton = function (model) {
	var buttonClass = model.liked ? 'fa fa-heart' : 'fa fa-heart-o';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
